    ...
    <View style={styles.container}>
      <View style={styles.profileInfo}>
        ...
        <View style={styles.profile}>
          <Image
            source={require("./assets/jmelo.jpg")}
            style={styles.image}
          />
          <View style={styles.name}>
            <Text style={styles.bio}>John Dumelo</Text>
            <Text style={styles.position}>Senior Partner</Text>
          </View>
        </View>
        </TouchableOpacity>
        ...
        <View style={styles.address}>
          ...
          <Text   style={styles.addressInfo}>jmelo@gmail.com</Text>
        </View>

        <View style={styles.address}>
          <SimpleLineIcons name="location-pin" size={20} color="black" />
          <Text style={styles.addressInfo}>Florida, USA</Text>
        </View>
      </View>
    </View>
  );
